...
from lmdb_sensor_storage._packer import *
from lmdb_sensor_storage.sensor_db import *
from lmdb_sensor_storage._old_api import pack, unpack
import tempfile
import shutil
...
class TestcaseSensor(EmptyDatabaseMixin, unittest.TestCase):
    ...
    def test_write_read_float_decimate(self):
        ...
        self.assertEqual(s.items(decimate_to_s=7, timestamp_chunker=timestamp_chunker_center, value_chunker=value_chunker_mean),
        ...
        self.assertEqual(
            s.items(decimate_to_s=7, timestamp_chunker=timestamp_chunker_minmeanmax, value_chunker=value_chunker_minmeanmax),
            list(zip(d,v)))
